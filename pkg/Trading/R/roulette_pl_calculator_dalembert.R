...
#'  initial_capital = 20000, simulations_num = 1000, trials_per_sim = 10000)
#' summary(pl_results$min_capital)
#' summary(pl_results$max_capital)
#' summary(pl_results$final_capital)
#' 
roulette_pl_calculator_dalembert <- function(bet_minimum, bet_maximum, initial_capital, simulations_num, trials_per_sim)  {
